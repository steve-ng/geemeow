$(document).ready(function () {
	...
	if ((userAgent.search("android|chrome") > -1) && (userAgent.search("mobile") > -1)){
		hideNonEssentialElement();
	}else if ((userAgent.search("iphone") > -1)){
		hideNonEssentialElement();
	}

        //TODO, check for other type of mobile 


        function hideNonEssentialElement(){
        	$('#cat_holder').hide();
        	$('#for_geek_info').hide();
        }
        ...
        $('#for_geek').on('shown.bs.popover', function () {
        	...
        	$('#geek_redirect').click(function(e){
        		...
        		window.location.replace("/g/experimental.html");
        	})
