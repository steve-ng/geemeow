...
function NodeStarServer(serverPeerId){
  ...
  this.isEmpty = function(){
    return Object.keys(peerSockets).length == 0;
  }

  this.isFull = function(){
    return Object.keys(peerSockets).length >= userLimit;
  }
  ...
  //  Stop the server
  this.stop = function(){
    for (var i = 0 ; i < peerSockets.length; i++){
      console.log("stop "+peerSockets[i].peerId);
      var socket = peerSockets[i];
      socket.emit('disconnected', 'TimeLimitExceeded');
      socket.disconnect();
    }
  }
